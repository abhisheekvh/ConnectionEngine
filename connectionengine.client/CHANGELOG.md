...
- Create Angular project with ng: `ng new connectionengine.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`connectionengine.client.esproj`).
